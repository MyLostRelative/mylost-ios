...
extension TitleAndDescriptionCardTableCell {
    public struct ViewModel {
        ...
        public init(headerModel: HeaderWithDetails.ViewModel, cardModel: RoundedTitleAndDescription.ViewModel) {
...
extension TitleAndDescriptionCardTableCell {
    public struct CellModel: TableCellModel {
        public var nibIdentifier: String = "TitleAndDescriptionCardTableCell"
        public var height: Double = Double(UITableView.automaticDimension)
        let headerModel: HeaderWithDetails.ViewModel
        let cardModel: RoundedTitleAndDescription.ViewModel
