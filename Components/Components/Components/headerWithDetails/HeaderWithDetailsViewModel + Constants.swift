...
extension HeaderWithDetails {
    ...
    public struct RightIcon {
        ...
        public init(rightIconIsActive: Bool, rightIconActive: UIImage?, rightIconDissable: UIImage?, rightIconHide: Bool, onTap: ((HeaderWithDetails) -> ())?) {
            self.rightIconIsActive = rightIconIsActive
            self.rightIconActive = rightIconActive
            self.rightIconDissable = rightIconDissable
            self.rightIconHide = rightIconHide
            self.onTap = onTap
        }
    }
